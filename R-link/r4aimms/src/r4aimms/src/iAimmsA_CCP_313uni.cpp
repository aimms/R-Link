...
typedef aimmsifc::ccp2uni_t CONVERTER_TO_AIMMS;
typedef aimmsifc::uni2ccp_t CONVERTER_FROM_AIMMS;
...
class iAimmsA_CCP_313uni : public iAimmsA, public iFactoryManage
{
...
public:
	iAimmsA_CCP_313uni(const char *szFileName)
		: m_Library(szFileName)
		, INIT_FUNCTION_POINTERS
	{}
	virtual ~iAimmsA_CCP_313uni() {}
...
{
	return new iAimmsA_CCP_313uni(dllname);
}

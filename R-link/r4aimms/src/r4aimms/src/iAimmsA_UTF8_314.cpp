...
*/
// An ASCII interface (assuming UTF8) to a 3.14 Unicode libaimms3
...
typedef aimmsifc::utf82uni_t CONVERTER_TO_AIMMS;
typedef aimmsifc::uni2utf8_t CONVERTER_FROM_AIMMS;
...
// We want to access the 'W' postfix methods in the libaimms3 library
#define DECORATED_DLL_NAME_T DECORATED_DLL_NAME_W

namespace aimmsifc {

class iAimmsA_UTF8_314 : public iAimmsA, public iFactoryManage
{
...
public:
	iAimmsA_UTF8_314(const char *szFileName)
		: m_Library(szFileName)
		, INIT_FUNCTION_POINTERS
	{}
	virtual ~iAimmsA_UTF8_314() {}
...
{
	return new iAimmsA_UTF8_314(dllname);
}

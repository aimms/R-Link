...
*/
// An ASCII interface (assuming CurrentCodePage) to a 3.13 (or earlier) Unicode libaimms
...
class iAimmsA_UTF8_313uni : public iAimmsA, public iFactoryManage
{
...
public:
	iAimmsA_UTF8_313uni(const char *szFileName)
		: m_Library(szFileName)
		, INIT_FUNCTION_POINTERS
	{}
	virtual ~iAimmsA_UTF8_313uni() {}
...
{
	return new iAimmsA_UTF8_313uni(dllname);
}
